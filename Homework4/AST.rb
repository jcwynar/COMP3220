  ...
  # attr_accessor :token
   ...
   def shiftSiblingsDown()
      ...
      if (t.getFirstChild() != nil)
         prev_sibling = t.getNextSibling()
         t.setNextSibling(nil)
         while (t.getFirstChild() != nil and prev_sibling != nil)
            x = t.getFirstChild().getNextSibling()
            t.getFirstChild().setNextSibling(prev_sibling)
            prev_sibling = x
            t = t.getFirstChild()
         end
      end
